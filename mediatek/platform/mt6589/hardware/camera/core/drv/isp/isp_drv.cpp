...
{
    int cmd;
    LOG_DBG("- E. isp_cq[0x%x],descri_cq[0x%x],[%d]",cq,mIspDrvCqMappinig[cq].descriptorCq,moduleId);
    //
...
//    LOG_DBG("singleton[0x%08x]", (int)&singleton);
    LOG_INF("singleton[0x%08x]. fgIsGdmaMode: %d.", (int)&singleton, fgIsGdmaMode);
