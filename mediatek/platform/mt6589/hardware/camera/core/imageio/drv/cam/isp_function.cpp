...
=   {   {{0x07C008a8, 0x0000003D, 0x00001102  },  // IC_RAW(0)
         {0x07C008a8, 0x0000003D, 0x00001102  },  // IC_YUV
         {0x07C008a8, 0x0000003D, 0x00001102  },  // IC_JPG
         {0x00000000, 0x00000000, 0x00000000  },  // DUMMY
         {0x00000000, 0x00000000, 0x00000000  }}, // DUMMY
        {{0x07C008a8, 0x0000003D, 0x00001102  },  // VR_RAW(1)
         {0x07C008a8, 0x0000003D, 0x00001102  },  // VR_YUV
         {0x00000000, 0x00000000, 0x00000000  },  // DUMMY
         {0x00000000, 0x00000000, 0x00000000  },  // DUMMY
         {0x00000000, 0x00000000, 0x00000000  }}, // DUMMY
        {{0x07C00800, 0x0000003D, 0x00001100  },  // ZSD_RAW(2)
         {0x07C008a8, 0x0000003D, 0x00001102  },  // ZSD_YUV
         {0x00000000, 0x00000000, 0x00000000  },  // DUMMY
         {0x00000000, 0x00000000, 0x00000000  },  // DUMMY
         {0x00000000, 0x00000000, 0x00000000  }}, // DUMMY
        {{0x07C008a8, 0x0000003D, 0x00001102  },  // IP_RAW(3)
         {0x07C008a8, 0x0000003D, 0x00001102  },  // IP_YUV
         {0x07C008a8, 0x0000003D, 0x00001102  },  // IP_RGBW
         {0x07C008a8, 0x0000003D, 0x00001102  },  // IP_RGB_LOAD
         {0x07C008a8, 0x0000003D, 0x00001102  }}, // IP_MFB
        {{0x07C008a8, 0x0000003D, 0x00001102  },  // VEC_DUMMY(4)
         {0x00000000, 0x00000000, 0x00000000  },  // DUMMY
         {0x00000000, 0x00000000, 0x00000000  },  // DUMMY
         {0x00000000, 0x00000000, 0x00000000  },  // DUMMY
         {0x00000000, 0x00000000, 0x00000000  }}, // DUMMY
        {{0x07C008a8, 0x0000003D, 0x00001102  },  // Simultaneous_DUMMY(5)
         {0x00000000, 0x00000000, 0x00000000  },  // DUMMY
         {0x00000000, 0x00000000, 0x00000000  },  // DUMMY
         {0x00000000, 0x00000000, 0x00000000  },  // DUMMY
         {0x00000000, 0x00000000, 0x00000000  }}, // DUMMY
        {{0x07C00800, 0x0000003D, 0x00001100  },  // N3D_IC_RAW(6)
         {0x07C008a8, 0x0000003D, 0x00001102  },  // N3D_IC_YUV
         {0x00000000, 0x00000000, 0x00000000  },  // DUMMY
         {0x00000000, 0x00000000, 0x00000000  },  // DUMMY
         {0x00000000, 0x00000000, 0x00000000  }}, // DUMMY
        {{0x07C008a8, 0x0000003D, 0x00001102  },  // N3D_VR_RAW(7)
         {0x07C008a8, 0x0000003D, 0x00001102  },  // N3D_VR_YUV
         {0x07C008a8, 0x0000003D, 0x00001102  },  // N3D_VR_RGB
         {0x00000000, 0x00000000, 0x00000000  },  // DUMMY
         {0x00000000, 0x00000000, 0x00000000  }}  // DUMMY
    };
...
unsigned int turnEn1Tag=0x00, turnEn2Tag=0x00, turnDmaTag=0x00;
    ...
    ISP_FUNC_INF("path(%d),CQ(%d),en1(0x%08x),en2(0x%08x),dma(0x%08x),fmt(0x%08x),ctl(0x%08x),tcm_en(0x%08x),isIspOn(0x%x)", \
                                                          ...
                                                          this->tcm_en, \
                                                          this->isIspOn);
    ISP_FUNC_DBG("int_en(0x%08x),intb_en(0x%08x),intc_en(0x%08x),dma_int(0x%x),dmab_int(0x%x),dmac_int(0x%x)", \
                                                          this->ctl_int.int_en, \
    ...
    if (ISP_PASS1 == this->path) {
        ...
        if (m_pIspDrv->IsReadOnlyMode())
        {
            ...
            //
            ISP_IOCTL_WRITE_REG(m_pIspDrv, m_pIspDrv->getRegAddrMap(),  CAM_CTL_MUX_SEL_CLR, ( CQ_CAM_CTL_CAN_BE_CLR_BITS(MUX_SEL,this->isIspOn)&(~0x20008000) )&(~ctl_mux_sel.reg_val));
            //
        ...
        else
        {
            ...
            //
            ISP_WRITE_REG(m_pIspReg,  CAM_CTL_MUX_SEL_CLR, ( CQ_CAM_CTL_CAN_BE_CLR_BITS(MUX_SEL,this->isIspOn)&(~0x20008000) )&(~ctl_mux_sel.reg_val));
            //
...
#if 1
        //
        ISP_FUNC_INF("wait 1 VD till DMA stop");
        //
...
getDmaBufIdx( MUINT32 dmaChannel )
{
    ...
    switch(dmaChannel) {
        ...
        case ISP_DMA_LCEI:
            ...
            break;
        default:
            ISP_FUNC_ERR("Invalid dma channel ");
            return -1;
    }
