...
/*
    ...
    switch (meScenarioFmt) {
        case eScenarioFmt_RAW:
            ...
            //enable table
#if 0  //kk test default:1
            enable1 |= CAM_CTL_EN1_CAM_EN|CAM_CTL_EN1_GGM_EN|CAM_CTL_EN1_CFA_EN;
            enable2 |= CAM_CTL_EN2_CDRZ_EN|CAM_CTL_EN2_C42_EN|CAM_CTL_EN2_G2C_EN|pass1_cq_en;
        ...
        case eScenarioFmt_YUV:
            ...
            enable2 |= CAM_CTL_EN2_CDRZ_EN|CAM_CTL_EN2_C42_EN|pass1_cq_en;
#else
