...
static void init_lcm_registers(void)
{
	...
	data_array[3] = 0x00000033;  	
	dsi_set_cmdq(data_array, 4, 1);	


	data_array[0] = 0x00063902;                          
	data_array[1] = 0x172423c4;  
	data_array[2] = 0x00005917; 	
	dsi_set_cmdq(data_array, 3, 1);	
	...
	data_array[0] = 0x000a3902;                          
	data_array[1] = 0x561441d2;  
	data_array[2] = 0x62060c37;  
	data_array[3] = 0x00000323;  	
	dsi_set_cmdq(data_array, 4, 1);

	data_array[0] = 0x000a3902;                          
	data_array[1] = 0x551452d3;  
	data_array[2] = 0x62060237;  
	data_array[3] = 0x00000323;  	
	dsi_set_cmdq(data_array, 4, 1);

	data_array[0] = 0x000a3902;                          
	data_array[1] = 0x561441d4;  
	data_array[2] = 0x62060c37;  
	data_array[3] = 0x00000323;  	
	dsi_set_cmdq(data_array, 4, 1);

	data_array[0] = 0x000a3902;                          
	data_array[1] = 0x551452d5;  
	data_array[2] = 0x62060237;  
	data_array[3] = 0x00000323;  	
	dsi_set_cmdq(data_array, 4, 1);
...
static void lcm_get_params(LCM_PARAMS *params)
	{
       ...
       //1 SSD2075 has no TE Pin
		...
		params->dsi.vertical_backporch					= 8 ; //---14   12	zhuxiankun 12
...
static unsigned int lcm_compare_id(void)
{
    ...
    #ifdef BUILD_LK
	printf("%s, LK LG4591 id0 = 0x%08x\n", __func__, id0);
	printf("%s, LK LG4591 id1 = 0x%08x\n", __func__, id1);
	printf("%s, LK LG4591 id = 0x%08x\n", __func__, id);
   #else
	printk("%s, Kernel LG4591 id0 = 0x%08x\n", __func__, id0);
	printk("%s, Kernel LG4591 id1 = 0x%08x\n", __func__, id1);
	printk("%s, Kernel LG4591 id = 0x%08x\n", __func__, id);
   #endif
#endif
   return 1;//(LCM_ID_LG4591 == id)?1:0;
...
LCM_DRIVER lg4591_dsi_vdo_lcm_drv = 
{
    .name			= "lg4591_dsi_vdo",
